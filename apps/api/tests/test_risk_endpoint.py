...
class TestRiskEndpoint:
    ...
    def test_risk_endpoint_basic_request(self):
        ...
        with patch('app.main.collect_samples') as mock_collect_samples, \
            ...
            mock_samples = [
                WeatherSample(
                    timestamp_utc=datetime(2020, 6, 15, 14, 0, tzinfo=timezone.utc),
    ...
    def test_risk_endpoint_validation(self):
        ...
        # Invalid latitude
        response = self.client.post("/risk", json={
