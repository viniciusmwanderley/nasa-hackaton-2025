...
class TestWeatherSample:
    ...
    def test_weather_sample_creation(self):
        ...
        sample = WeatherSample(
            ...
            timestamp=datetime(2023, 6, 15, 10, 0, tzinfo=timezone.utc),
            latitude=-3.7275,
            longitude=-38.5275
        )
    ...
    def test_weather_sample_cold_conditions(self):
        ...
        sample = WeatherSample(
            ...
            timestamp=datetime(2023, 12, 15, 10, 0, tzinfo=timezone.utc),
            latitude=45.0,
            longitude=-75.0
        )
    ...
    def test_weather_sample_moderate_conditions(self):
        ...
        sample = WeatherSample(
            ...
            timestamp=datetime(2023, 9, 15, 10, 0, tzinfo=timezone.utc),
            latitude=40.7128,
            longitude=-74.0060
        )
        ...
        assert sample.feels_like_c == sample.temperature_c  # Should use actual temperature
    ...
    def test_from_power_data(self):
        ...
        date = datetime(2023, 7, 4, 12, 0, tzinfo=timezone.utc)
...
class TestWeatherConditionFlags:
    ...
    def test_flags_creation_and_methods(self):
        ...
        assert flags.to_dict() == {
            "very_hot": False, "very_cold": False, 
            "very_windy": False, "very_wet": False
        }
...
class TestEvaluateSampleRisk:
    ...
    def test_evaluate_sample_risk_comprehensive(self):
        ...
        sample = WeatherSample(
            ...
            timestamp=datetime(2023, 8, 15, 14, 30, tzinfo=timezone.utc),
