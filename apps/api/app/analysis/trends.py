...
def calculate_ols_slope_and_pvalue(
...
def calculate_trend(
    ...
    for year in sorted_years:
        points.append(TrendPoint(year=year, exceedance_rate=yearly_rates[year]))
