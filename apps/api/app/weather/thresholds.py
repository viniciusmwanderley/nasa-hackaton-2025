...
from .calculations import feels_like_temperature, heat_index, wind_chill
...
class WeatherSample:
    ...
    heat_index_c: float | None = None  # Calculated heat index
    wind_chill_c: float | None = None  # Calculated wind chill
    feels_like_c: float | None = None  # Calculated "feels like" temperature
    ...
    def __post_init__(self):
        ...
        self.feels_like_c = feels_like_temperature(
            self.temperature_c, self.relative_humidity, self.wind_speed_ms
        )
...
def is_very_hot(sample: WeatherSample, settings: Settings | None = None) -> bool:
    """
...
def is_very_cold(sample: WeatherSample, settings: Settings | None = None) -> bool:
    """
...
def is_very_windy(sample: WeatherSample, settings: Settings | None = None) -> bool:
    """
...
def is_very_wet(sample: WeatherSample, settings: Settings | None = None) -> bool:
    """
...
def flag_weather_conditions(
    sample: WeatherSample, settings: Settings | None = None
